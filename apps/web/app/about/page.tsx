    ...
    <>
      ...
      >
        <div className="grid gap-6 lg:grid-cols-[1fr_.9fr]">
          ...
          <div className="rounded-[2rem] border border-oxblood/10 bg-porcelain p-8">
      ...
      <Section eyebrow="Core Values" title="The principles behind every recommendation.">
        <div className="grid gap-4 md:grid-cols-5">
          {values.map((value) => (
            <div key={value} className="rounded-2xl border border-oxblood/10 bg-white p-5 text-center font-bold">
